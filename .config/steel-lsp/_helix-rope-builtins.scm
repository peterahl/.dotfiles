...
(#%module-add-doc #%helix-rope-module "rope-char->byte" "Convert the character offset into a byte offset for a given rope")
...
(#%module-add-doc #%helix-rope-module "rope-byte->char" "Convert the byte offset into a character offset for a given rope")
